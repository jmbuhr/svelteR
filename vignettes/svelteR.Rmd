...
Where "svelte-app" is the name of the folder you want to create the app in. Here
are the two files modified to ensure that it works as a standalone app, as well
...
-   Custom css for your Rmarkdown document, under which the bootstrap framework
    ...
    over `global.css` in your `svelte-app/public/` folder.
